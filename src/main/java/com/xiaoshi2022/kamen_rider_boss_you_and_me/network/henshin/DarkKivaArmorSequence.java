...
public final class DarkKivaArmorSequence {
    private DarkKivaArmorSequence() {}
    
    /** 穿3件DarkKiva装甲：头盔、胸甲、护腿 */
    ...
    private static ItemStack[] saveArmor(ServerPlayer p) {
    ...
    private static void giveBack(ServerPlayer p, ItemStack[] old) {
        // 优先返还鞋子
