...
public class RessyaItem extends Item implements GeoItem {

    private static final RawAnimation IDLE = RawAnimation.begin().thenPlayAndHold("idle");

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public RessyaItem(Properties properties) {
        super(properties);
    }
    ...
    private <E extends GeoItem> PlayState animationController(AnimationState<E> state) {
        ...
        if (stack == null || !(state.getAnimatable() instanceof RessyaItem))
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private com.xiaoshi2022.kamen_rider_boss_you_and_me.Items.client.property.RessyaItemRenderer renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.renderer == null)
                    this.renderer = new com.xiaoshi2022.kamen_rider_boss_you_and_me.Items.client.property.RessyaItemRenderer();
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (beltOpt.isPresent()) {
            ...
            if (currentMode == BuildDriver.BeltMode.HAZARD_EMPTY || currentMode == BuildDriver.BeltMode.HAZARD_K) {
                BuildDriver.BeltMode newMode = currentMode == BuildDriver.BeltMode.HAZARD_EMPTY ? 
                    BuildDriver.BeltMode.HAZARD_RESSYA : BuildDriver.BeltMode.HAZARD_KR;
    ...
    public Component getName(ItemStack stack) {
        return Component.translatable("item.kamen_rider_boss_you_and_me.ressya");
    }
}
