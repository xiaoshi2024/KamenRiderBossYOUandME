...
public class GiifuEyeBallModel  <T extends GeoAnimatable> extends DefaultedGeoModel<T> {
    /**
     ...
     * }</pre>
     */
    public GiifuEyeBallModel(ResourceLocation assetSubpath) {
        super(assetSubpath);
    }
     ...
     */
    @Override
    public GiifuEyeBallModel<T> withAltModel(ResourceLocation altPath) {
        return (GiifuEyeBallModel<T>)super.withAltModel(new ResourceLocation(kamen_rider_boss_you_and_me.MODID,"geo/item/giifu_eyeball.geo.json"));
    }
     ...
     */
    @Override
    public GiifuEyeBallModel<T> withAltAnimations(ResourceLocation altPath) {
        return (GiifuEyeBallModel<T>)super.withAltAnimations(new ResourceLocation(kamen_rider_boss_you_and_me.MODID,"animations/item/giifu_eyeball.animation.json"));
    }
     ...
     */
    @Override
    public GiifuEyeBallModel<T> withAltTexture(ResourceLocation altPath) {
        return (GiifuEyeBallModel<T>)super.withAltTexture(new ResourceLocation(kamen_rider_boss_you_and_me.MODID,"textures/item/giifu_eyeball.png"));
    }
}