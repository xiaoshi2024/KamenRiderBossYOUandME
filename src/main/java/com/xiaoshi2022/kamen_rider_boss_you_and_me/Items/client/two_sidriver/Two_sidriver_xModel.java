...
public class Two_sidriver_xModel extends GeoModel<Two_sidriver> {
    @Override
    public ResourceLocation getModelResource(Two_sidriver animatable) {
        return new ResourceLocation("kamen_rider_boss_you_and_me", "geo/item/two_sidriver_x.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(Two_sidriver animatable) {
        return new ResourceLocation("kamen_rider_boss_you_and_me", "animations/item/two_sidriver_x.animation.json");
    }
}