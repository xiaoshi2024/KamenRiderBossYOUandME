...
public class GenesisDriverModel extends GeoModel<Genesis_driver> {
    public GenesisDriverModel(ResourceLocation Genesis_driver) {
        super();
    }
    ...
    public ResourceLocation getModelResource(Genesis_driver animatable) {
        // 返回模型资源的位置
        return new ResourceLocation("kamen_rider_boss_you_and_me", "geo/item/genesis_driver.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(Genesis_driver animatable) {
        return new ResourceLocation("kamen_rider_boss_you_and_me", "animations/item/genesis_driver.animation.json");
    }
}