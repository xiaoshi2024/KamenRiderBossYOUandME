...
public class sengokudrivers_epmtysRenderer extends GeoItemRenderer<sengokudrivers_epmty> implements ICurioRenderer {
    ...
    @Override
    public GeoModel<sengokudrivers_epmty> getGeoModel() {
        ItemStack stack = getCurrentItemStack();
        if (stack.getItem() instanceof sengokudrivers_epmty) {
            sengokudrivers_epmty belt = (sengokudrivers_epmty) stack.getItem();
            sengokudrivers_epmty.BeltMode mode = belt.getMode(stack);
