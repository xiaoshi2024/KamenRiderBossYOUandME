...
public final class MelonRiderHenshin {

    private MelonRiderHenshin() {}
    ...
    public static void trigger(Player player) {
        ...
        // 穿上蜜瓜装甲
        player.setItemSlot(EquipmentSlot.HEAD,  new ItemStack(ModItems.ZANGETSU_SHIN_HELMET.get()));
        player.setItemSlot(EquipmentSlot.CHEST, new ItemStack(ModItems.ZANGETSU_SHIN_CHESTPLATE.get()));
        player.setItemSlot(EquipmentSlot.LEGS,  new ItemStack(ModItems.ZANGETSU_SHIN_LEGGINGS.get()));
        // 清空鞋子槽位
