...
public final class DragonfruitRiderHenshin {

    private DragonfruitRiderHenshin() {}
    ...
    public static void trigger(Player player) {
        ...
        // 穿上火龙果装甲
        player.setItemSlot(EquipmentSlot.HEAD,  new ItemStack(ModItems.TYRANT_HELMET.get()));
        player.setItemSlot(EquipmentSlot.CHEST, new ItemStack(ModItems.TYRANT_CHESTPLATE.get()));
        player.setItemSlot(EquipmentSlot.LEGS,  new ItemStack(ModItems.TYRANT_LEGGINGS.get()));
        // 清空鞋子槽位
