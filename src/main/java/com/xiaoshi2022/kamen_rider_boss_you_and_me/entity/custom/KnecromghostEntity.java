...
public class KnecromghostEntity extends LivingEntity implements GeoEntity {
    private static final RawAnimation IDLE = RawAnimation.begin().thenPlay("idle");
    private static final RawAnimation HENSIN = RawAnimation.begin().thenPlay("possessed");
    ...
    public KnecromghostEntity(EntityType<? extends LivingEntity> type, Level world) {
        super(type, world);
        this.noPhysics = true;
    ...
    private PlayState predicate(AnimationState<KnecromghostEntity> event) {
        if (isHenshin) {
