...
public class DarkKivaArmorRenderer extends GeoArmorRenderer<DarkKivaItem> {
    ...
    @Override
    public RenderType getRenderType(DarkKivaItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
