...
public class DarkRiderGhostArmorRenderer extends GeoArmorRenderer<DarkRiderGhostItem> {
    ...
    @Override
    public RenderType getRenderType(DarkRiderGhostItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
