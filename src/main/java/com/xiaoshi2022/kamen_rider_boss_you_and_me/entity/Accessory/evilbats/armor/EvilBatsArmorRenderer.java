...
public class EvilBatsArmorRenderer extends GeoArmorRenderer<EvilBatsArmor> {
    ...
    @Override
    public RenderType getRenderType(EvilBatsArmor animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
