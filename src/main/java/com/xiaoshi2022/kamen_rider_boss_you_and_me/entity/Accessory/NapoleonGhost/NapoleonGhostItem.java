package com.xiaoshi2022.kamen_rider_boss_you_and_me.entity.Accessory.NapoleonGhost;

import com.xiaoshi2022.kamen_rider_boss_you_and_me.entity.Accessory.NapoleonGhost.NapoleonGhost.NapoleonGhostArmorRenderer;
...
public class NapoleonGhostItem extends ArmorItem implements GeoItem, KamenBossArmor, ArmorAnimationFactory.AnimatableAccessor {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public String animationprocedure = "empty";

    public NapoleonGhostItem(ArmorItem.Type type, Item.Properties properties) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new NapoleonGhostArmorRenderer();
