...
public class NoxKnightArmorRenderer extends GeoArmorRenderer<NoxKnight> {
    public NoxKnightArmorRenderer() {
        super(new NoxKnightModel());
    ...
    @Override
    public RenderType getRenderType(NoxKnight animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
