package com.xiaoshi2022.kamen_rider_boss_you_and_me.entity.Accessory.brain;
...
public class Brain extends ArmorItem implements GeoItem, KamenBossArmor, ArmorAnimationFactory.AnimatableAccessor {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public String animationprocedure = "empty";

    public Brain(ArmorItem.Type type, Item.Properties properties) {
        super(new ArmorMaterial() {
            ...
            public Ingredient getRepairIngredient() {
                return Ingredient.of(Items.EMERALD, Items.GOLD_INGOT); // 钻石和金锭象征高贵
            }

            // 材质名称 - 使用内置的netherite材质，避免Minecraft尝试加载不存在的brain_layer_1.png纹理
            @Override
