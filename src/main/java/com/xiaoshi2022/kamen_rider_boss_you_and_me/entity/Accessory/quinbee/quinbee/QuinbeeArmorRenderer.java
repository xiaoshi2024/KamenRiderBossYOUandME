...
public class QuinbeeArmorRenderer extends GeoArmorRenderer<QuinbeeItem> {
    public QuinbeeArmorRenderer() {
        super(new QuinbeeModel());
    ...
    @Override
    public RenderType getRenderType(QuinbeeItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
