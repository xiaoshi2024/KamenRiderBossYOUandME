...
public class DarkOrangelsArmorRenderer extends GeoArmorRenderer<Dark_orangels> {
    ...
    @Override
    public RenderType getRenderType(Dark_orangels animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
