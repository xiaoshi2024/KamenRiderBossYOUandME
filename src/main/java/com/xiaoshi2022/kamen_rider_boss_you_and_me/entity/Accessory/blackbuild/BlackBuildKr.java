...
import com.xiaoshi2022.kamen_rider_boss_you_and_me.entity.Accessory.blackbuild.build_kr_form.BlackBuildKrArmorRenderer;
...
public class BlackBuildKr extends ArmorItem implements GeoItem, KamenBossArmor, ArmorAnimationFactory.AnimatableAccessor {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public String animationprocedure = "empty";

    public BlackBuildKr(ArmorItem.Type type, Item.Properties properties) {
    ...
    public static boolean isFullArmorEquipped(ServerPlayer player) {
        return player.getInventory().armor.get(3).getItem() instanceof BlackBuildKr &&
               player.getInventory().armor.get(2).getItem() instanceof BlackBuildKr &&
               player.getInventory().armor.get(1).getItem() instanceof BlackBuildKr;
    }
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new BlackBuildKrArmorRenderer();
