...
public class LemonxEntity extends BlockEntity implements GeoBlockEntity {
    //定义动画
    ...
    public static void tick(Level level, BlockPos pos, BlockState state, LemonxEntity entity) {
