...
public class cherryxEntity extends BlockEntity implements GeoBlockEntity {
    //定义动画
    ...
    public cherryxEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CHERRYX_ENTITY.get(), pos, state);
    }
    ...
    public static void tick(Level level, BlockPos pos, BlockState state, cherryxEntity entity) {
