...
public class OrangelsxEntity extends BlockEntity implements GeoBlockEntity {
    //定义动画
    ...
    public OrangelsxEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ORANGELSX_ENTITY.get(), pos, state);
    }
    ...
    public static void tick(Level level, BlockPos pos, BlockState state, OrangelsxEntity entity) {
