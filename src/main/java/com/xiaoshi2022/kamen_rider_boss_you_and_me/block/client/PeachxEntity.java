...
public class PeachxEntity extends BlockEntity implements GeoBlockEntity {
    //定义动画
    ...
    public PeachxEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.PEACHX_ENTITY.get(), pos, state);
    }
    ...
    public static void tick(Level level, BlockPos pos, BlockState state, PeachxEntity entity) {
