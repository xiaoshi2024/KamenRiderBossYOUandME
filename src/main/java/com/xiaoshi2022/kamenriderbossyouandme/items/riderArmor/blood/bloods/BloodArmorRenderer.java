...
public class BloodArmorRenderer extends GeoArmorRenderer<Blood> {
    public BloodArmorRenderer() {
        super(new BloodModel());
    ...
    @Override
    public RenderType getRenderType(Blood animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
