package com.xiaoshi2022.kamenriderbossyouandme.items.riderArmor.duke;

import com.xiaoshi2022.kamenriderbossyouandme.items.riderArmor.duke.dukes.DukeArmorRenderer;
...
public class Duke extends ArmorItem implements GeoItem {
    ...
    public Duke(Holder<ArmorMaterial> armorMaterial, Type type, Properties properties) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private final DukeArmorRenderer renderer = new DukeArmorRenderer();
