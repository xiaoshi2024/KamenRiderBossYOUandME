package com.xiaoshi2022.kamenriderbossyouandme.items.riderArmor.evilbats;

import com.xiaoshi2022.kamenriderbossyouandme.items.riderArmor.evilbats.armor.EvilBatsArmorRenderer;
...
public class EvilBats extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public String animationprocedure = "empty";

    public EvilBats(Holder<ArmorMaterial> armorMaterial, Type type, Properties properties) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private final EvilBatsArmorRenderer renderer = new EvilBatsArmorRenderer();
