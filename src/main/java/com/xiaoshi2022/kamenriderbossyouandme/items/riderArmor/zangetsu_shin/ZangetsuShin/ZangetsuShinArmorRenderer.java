...
public class ZangetsuShinArmorRenderer extends GeoArmorRenderer<zangetsuShin> {
    ...
    @Override
    public RenderType getRenderType(zangetsuShin animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
