...
public class RiderbaronsArmorRenderer extends GeoArmorRenderer<RiderBarons> {
    ...
    @Override
    public RenderType getRenderType(RiderBarons animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
