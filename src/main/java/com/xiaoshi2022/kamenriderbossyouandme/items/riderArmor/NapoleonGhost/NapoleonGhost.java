package com.xiaoshi2022.kamenriderbossyouandme.items.riderArmor.NapoleonGhost;

import com.xiaoshi2022.kamenriderbossyouandme.items.riderArmor.NapoleonGhost.NapoleonGhosts.NapoleonGhostArmorRenderer;
...
public class NapoleonGhost extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public String animationprocedure = "empty";

    public NapoleonGhost(Holder<ArmorMaterial> armorMaterial, Type type, Properties properties) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private final NapoleonGhostArmorRenderer renderer = new NapoleonGhostArmorRenderer();
