...
import com.xiaoshi2022.kamenriderbossyouandme.items.riderArmor.blackbuild.build_kr_form.BlackBuildKrArmorRenderer;
...
public class BlackBuildKr extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public BlackBuildKr(Holder<ArmorMaterial> armorMaterial, Type type, Properties properties) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private final BlackBuildKrArmorRenderer renderer = new BlackBuildKrArmorRenderer();
