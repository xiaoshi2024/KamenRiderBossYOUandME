...
public class QuinbeeArmorRenderer extends GeoArmorRenderer<Quinbee> {
    ...
    @Override
    public RenderType getRenderType(Quinbee animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
