package com.xiaoshi2022.kamenriderbossyouandme.items.riderArmor.rider_necrom;

import com.xiaoshi2022.kamenriderbossyouandme.items.riderArmor.rider_necrom.Ridernecroms.RidernecromArmorRenderer;
...
public class RiderNecrom extends ArmorItem implements GeoItem {
    ...
    public RiderNecrom(Holder<ArmorMaterial> armorMaterial, Type type, Properties properties) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private final RidernecromArmorRenderer renderer = new RidernecromArmorRenderer();
